/*
 * ╔═══════════════════════════════════════════════════════════════════════════╗
 * ║  3CX Call Processing Script: Twilio WhatsApp SMS with Landline Detection  ║
 * ║  Version: 6.6 - Fast Digit Playback & Instant Confirmation                ║
...
namespace dummy
{
    public class TwilioWhatsAppSMSSender : ScriptBase<TwilioWhatsAppSMSSender>
    {
        // ═══════════════════════════════════════════════════════════════════
        ...
        public override async void Start()
        {
            await Task.Run(async () =>
            {
                ...
                {
                    MyCall.Info("╔═══════════════════════════════════════════════════════════╗");
                    MyCall.Info("║  TwilioWhatsAppSMS v6.6 - Fast Playback                   ║");
                    MyCall.Info("╚═══════════════════════════════════════════════════════════╝");
